    ...
    return (
      <>
        ...
        <SummaryCard
          ...
          styles={{ width: "100%" }}
        >
          <div className={styles.conditionDetailCard}>
            <table className={styles.conditionDetailTable}>
              <thead>
                <tr>
                  <td>Last updated</td>
